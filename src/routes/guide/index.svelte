          ...
          <ol style="list-style: decimal; padding-left: 30px">
            ...
            <li>
              ...
              <ol style="list-style: decimal; padding-left: 30px">
                <li>
                  <a href="#edit-profile"
                    >Edit your {branding.projectName} profile</a
                  >
                </li>
              </ol>
            </li>
        ...
        <div class="guide">
            ...
            <ol style="list-style: decimal; padding-left: 30px">
              ...
              <li>
                <p>
                  ...
                  log into your {branding.projectName} account you will be prompted
          ...
          <div class="item" id="fund-your-wallet">
            ...
            <p class="font-bold">
              ...
              to L-BTC within {branding.projectName}. This is probably the most
              straightforward and easiest way to get L-BTC in your {branding.projectName}
              wallet.
            </p>
            <p>
          ...
          <div class="item" id="liquid">
            ...
            <p>
              When selecting “Fund” in your {branding.projectName} wallet, you will
              be shown a Liquid non-confidential address in text format and in QR
              code. You can use this non-confidential address to send any Liquid
              asset including L-BTC, USDt (Liquid), or L-CAD directly to your {branding.projectName}
            ...
            <p>
              ...
              Liquid assets to your {branding.projectName} wallet. If you get an
              error in your Green or AQUA wallet saying “Non-Confidential addresses
              not supported” simply click on “Confidential” under the Liquid address
              and you will be shown a confidential address and corresponding QR code.
            </p>
            <img
              class="guide-image"
          ...
          <div class="item" id="btc-lightning">
            ...
            <p>
              You can also fund your {branding.projectName} Liquid wallet using Lightning.
              By selecting “Lightning” you will be presented with a Lightning invoice
              ...
              be sent to Coinos and automatically exchanged to L-BTC that will then
              be deposited in your {branding.projectName} Liquid wallet. Keep in
              mind that there is currently a minimum of 0.00001 btc (~1,000 sats)
              and a maximum of 0.01 BTC with this funding option.
            </p>
            <img
              class="guide-image"
          ...
          <div class="item" id="simple-listing">
            ...
            <p>
              ...
              associated it gets locked in {branding.projectName} to ensure that
              the original artists receive their royalties, which means the NFT cannot
              be transferred outside of the platform. If you want your NFT to be
          ...
          <div class="item" id="what-to-expect-after-listing">
            ...
            <p>
              ...
              for your piece), users will also be able to see this information. {branding.projectName}
              users will also see a countdown timer indicating when the auction ends.
              If someone bids in the last 15 min, this will automatically push the
              auction end time 15 min. Once an auction is finished, the NFT will
              automatically be transferred to the highest bidder and the money to
              the artist.
            </p>
          </div>
